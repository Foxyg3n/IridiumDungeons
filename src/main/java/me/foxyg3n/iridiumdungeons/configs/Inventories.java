...
public class Inventories {
    ...
    @JsonIgnore
    private final Background background = new Background(ImmutableMap.<Integer, Item>builder()
    ...
    public NoItemGUI dungeonsGUI = new NoItemGUI(27, "&7Dungeons", background);
